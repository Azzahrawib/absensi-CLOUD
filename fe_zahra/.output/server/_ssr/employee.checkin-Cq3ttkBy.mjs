...
import { i as getActiveEmployee, n as createAttendance } from "./db-_r_BwSlB.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { N as Check, P as Camera, T as LoaderCircle, b as MapPin, m as RefreshCcw, s as TriangleAlert, t as X } from "../_libs/lucide-react.mjs";
import { _ as useNavigate, v as useSearch } from "../_libs/@tanstack/react-router+[...].mjs";
import { i as useWorkMode, n as getVendor, r as haversine, t as OFFICE } from "./work-mode-BjZwHty8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/employee.checkin-Cq3ttkBy.js
...
function CheckinScreen() {
	...
	(0, import_react.useEffect)(() => {
		...
		}), () => setGpsError("Gagal membaca lokasi GPS."), { enableHighAccuracy: true });
	}, []);
	...
	const capturePhoto = () => {
		...
		setPhoto(canvas.toDataURL("image/jpeg", .7));
	};
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: attendanceType === "Check-In" ? "Presensi Masuk" : "Presensi Keluar"
				}),
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "relative w-full max-w-sm aspect-[3/4] rounded-3xl overflow-hidden bg-slate-900 border border-slate-800",
					children: photo ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: photo,
						alt: "Foto presensi",
						className: "w-full h-full object-cover"
					}) : cameraError ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "w-full h-full grid place-items-center p-6 text-center text-slate-400 text-sm gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "w-6 h-6 mx-auto text-amber-500 mb-2" }), cameraError]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "w-full max-w-sm rounded-2xl bg-slate-900 border border-slate-800 p-4 text-xs space-y-2",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "text-slate-400 flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "w-3.5 h-3.5" }), " Lokasi target"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold",
								children: target?.name ?? "Belum ditentukan"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: `font-mono font-bold ${withinRadius ? "text-emerald-400" : "text-red-400"}`,
								children: gpsError ? "GPS error" : distance !== null ? `${distance} m` : "Membaca..."
							})]
						}),
						attendanceType === "Check-In" && target && distance !== null && !withinRadius && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-red-400",
							children: [
								"Di luar radius ",
								target.radius,
								"m — presensi akan ditolak."
							]
						})
					]
				}),
				photo ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
						...
						onClick: retake,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCcw, { className: "w-4 h-4 mr-1.5" }), " Ambil Ulang"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
						className: "bg-emerald-600 hover:bg-emerald-500",
						onClick: handleSubmit,
						disabled: submitting || attendanceType === "Check-In" && !withinRadius,
						children: [submitting ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "w-4 h-4 mr-1.5 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "w-4 h-4 mr-1.5" }), "Kirim"]
					})]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button$1, {
					className: "w-full max-w-sm bg-indigo-600 hover:bg-indigo-500",
					onClick: capturePhoto,
					disabled: !!cameraError,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Camera, { className: "w-4 h-4 mr-1.5" }), " Ambil Foto"]
				}),
				attendanceType === "Check-Out" && !photo && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: handleSubmit,
					className: "text-xs text-slate-400 underline underline-offset-2",
					children: "Lewati foto & langsung check-out"
				})
			]
		})]
	});
