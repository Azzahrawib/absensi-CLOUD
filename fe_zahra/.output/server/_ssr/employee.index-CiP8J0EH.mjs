...
import { m as require_react, n as SwitchRoot, p as require_jsx_runtime, t as SwitchThumb } from "../_libs/@base-ui/react+[...].mjs";
import { a as getLatestAttendanceByEmployee, i as getActiveEmployee } from "./db-_r_BwSlB.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { A as Clock, C as LogIn, L as Building2, M as CircleCheck, R as Briefcase, S as LogOut, b as MapPin, d as ShieldCheck, f as ShieldAlert, l as Smartphone, n as Wifi, s as TriangleAlert, v as Navigation, z as Bell } from "../_libs/lucide-react.mjs";
import { _ as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as workStore, i as useWorkMode, n as getVendor, r as haversine, t as OFFICE } from "./work-mode-BjZwHty8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/employee.index-CiP8J0EH.js
...
function EmployeeHome() {
	...
	const assignedVendor = (0, import_react.useMemo)(() => getVendor(profile?.vendor_id), [profile?.vendor_id]);
	(0, import_react.useEffect)(() => {
	...
	const target = (0, import_react.useMemo)(() => {
		...
		if (assignedVendor) return {
			lat: assignedVendor.latitude,
			lng: assignedVendor.longitude,
			radius: assignedVendor.radius_m,
	...
	const latestAttendance = profile ? getLatestAttendanceByEmployee(profile.id) : void 0;
	const handleCheckIn = () => {
		if (!hasTarget) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: (profile?.full_name ?? "??").split(" ").map((p) => p[0]).slice(0, 2).join("").toUpperCase()
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-indigo-200",
							children: "Good shift,"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-semibold truncate max-w-[180px]",
							children: profile?.full_name ?? "Memuat..."
						})] })]
			...
			children: [
				mode === "vendor" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "rounded-2xl border bg-white dark:bg-slate-800 p-4 shadow-md",
					children: assignedVendor ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm font-semibold text-indigo-600",
						children: assignedVendor.name
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-[11px] text-slate-400 mt-1",
						children: assignedVendor.address
					})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-start gap-2 text-amber-600",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, { className: "w-4 h-4 mt-0.5 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs",
							children: "Anda belum diikat ke vendor location manapun. Hubungi admin HRD untuk pengaturan."
						})]
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: `rounded-2xl border bg-white dark:bg-slate-800 p-4 shadow-lg transition-all ${loadingGps || !hasTarget ? "border-slate-200" : safe ? "border-emerald-200" : "border-red-200"}`,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						disabled: !canCheckIn,
						title: !hasTarget ? "Belum terikat ke vendor" : !safe ? "Di luar radius lokasi" : void 0,
				...
				latestAttendance && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-2xl border bg-white dark:bg-slate-800 p-4 flex items-center gap-3",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "w-4 h-4 text-slate-400 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-xs text-slate-500",
						children: [
							"Aktivitas terakhir: ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-semibold text-slate-700 dark:text-slate-200",
								children: latestAttendance.type
							}),
							" pada",
							" ",
